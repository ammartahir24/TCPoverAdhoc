...
#		self.addr_configs = [("127.0.0.1", 5000), ("127.0.0.1", 6000), ("127.0.0.1", 7000), ("127.0.0.1", 8000)]
		...
		{
			("10.2.1.1", 1000): 0,
			("10.2.1.2", 1000): ("10.2.1.2", 1000),
			("10.2.1.3", 1000): ("10.2.1.2", 1000),
			("10.2.1.4", 1000): ("10.2.1.2", 1000)
		},
		{
			("10.2.1.1", 1000): ("10.2.1.1", 1000),
			("10.2.1.2", 1000): 0,
			("10.2.1.3", 1000): ("10.2.1.3", 1000),
			("10.2.1.4", 1000): ("10.2.1.3", 1000)
		},
		{
			("10.2.1.1", 1000): ("10.2.1.2", 1000),
			("10.2.1.2", 1000): ("10.2.1.2", 1000),
			("10.2.1.3", 1000): 0,
			("10.2.1.4", 1000): ("10.2.1.4", 1000)
		},
		{
			("10.2.1.1", 1000): ("10.2.1.3", 1000),
			("10.2.1.2", 1000): ("10.2.1.3", 1000),
			("10.2.1.3", 1000): ("10.2.1.3", 1000),
			("10.2.1.4", 1000): 0
		},
	]
		self.addr_configs = [("10.2.1.1", 1000), ("10.2.1.2", 1000), ("10.2.1.3", 1000), ("10.2.1.4", 1000)]
